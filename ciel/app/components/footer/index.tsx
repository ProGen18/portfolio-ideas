...
const FOOTER_LINKS = CONFIG.footerLinks;
...
const Copyright = () => {
  ...
  const onClick = (e: any) => {
    e.stopPropagation();
    window.open("https://www.stephane-talab.fr", "_blank");
  };

  const fontSize = isMobile ? 0.08 : 0.12;
  ...
  return (
    ...
    >
      {`© ${new Date().getFullYear()} — Conçu et maintenu par Stéphane TALAB pour ${CONFIG.name}`}
    </Text>
  );
};
